...
const Content = ({
  ...
  return (
    <>
      ...
      >
        <div
          className={cn('absolute z-50 mt-2 rounded-md shadow-lg', alignmentClasses, widthClasses)}
          onClick={() => setOpen(false)}
        >
          <div className={cn('ring-opacity-5 rounded-md ring-1 ring-black', contentClasses)}>{children}</div>
        </div>
      </Transition>
    </>
  )
