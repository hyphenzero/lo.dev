    ...
    <>
      <div
        className={cn(
          ...
          isHero ? 'bg-transparent' : 'bg-white/85 backdrop-blur-3xl dark:bg-zinc-950/90',
          ...
          <nav className="flex h-16 items-center justify-between">
            ...
            <div className="hidden items-center gap-8 md:flex">
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      isHeroText
                        ...
                        : active
                          ? 'text-blue-500'
                          : 'text-zinc-950 hover:text-zinc-600 dark:text-white dark:hover:text-zinc-300'
                    )}
                  >
                    {link.label}
                  </Link>
              ...
              {auth.user ? (
                ...
                <Button className={isHeroText ? 'dark dark:bg-blue-800 dark:hover:bg-blue-700' : ''} href={login()}>
                  Log in
                </Button>
              )}
            </div>
            ...
            <button
              ...
              className={cn('md:hidden', isHeroText ? 'text-white' : 'text-zinc-950 dark:text-white')}
