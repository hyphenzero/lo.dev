import { WEIGHT_BOLD, WEIGHT_REGULAR, type GlyphAtlas } from './glyph-atlas'
...
const twistAt = (spin: number, dist: number) => (spin * TWIST_RATE) / Math.max(CORE_FLOOR, dist)
